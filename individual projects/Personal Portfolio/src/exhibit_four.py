...
folder_path = r"C:\Users\strat\JS_CP2\other projects"
file_path = os.path.join(folder_path, "last_semester_final.py")
...
def display():
    ...
    title = styles.OutputText(titleframe.title, "Exhibit D", text_color=values["Jet Black"])
    title.show()
   ...
   #text = styles.OutputText(text_box.frame, text_color=from_rgb((0,0,0)), text_size=60, justify="left", text="Virtual Pet Simulator\nThis is another project where I finally cracked down on\nconsistency and formatting.\nI'd say this is probably my best project to date, just because of\nhow well executed everything is and how suprisingly fun it is.")
    text = styles.OutputText(text_box.frame, text_color=from_rgb((0,0,0)), text_size=60, justify="left", text="Last Semester's Final\n\nWhen I first starting finished making this project, it was\nby far the longest file I had ever written and I was generally\nimpressed with how detailed things are.\nI do think this project could be made to be a bit more fun though.")
    text.show()
